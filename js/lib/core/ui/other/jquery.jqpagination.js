...
(function ($) {
    ...
    $.jqPagination = function (el, options) {
		...
		base.init = function () {
			...
			base.$input.off( '.jqPagination').on('focus.jqPagination mouseup.jqPagination', function (event) {
			...
			base.$input.off( '.jqPagination' ).on('blur.jqPagination keydown.jqPagination', function (event) {
			...
			base.$el.off( '.jqPagination' ).on('click.jqPagination', 'a', function (event) {
		...
		base.setMaxPage = function (max_page, prevent_paged) {
			...
			if (!base.isNumber(max_page)) {
				debug.error('jqPagination: max_page is not a number');
				return false;
			}
			
			// ignore if max_page is less than the current_page
			if (max_page < base.options.current_page) {
				debug.error('jqPagination: max_page lower than current_page');
				return false;
			}
		...
		base.setInputValue = function (page) {
            ...
            if(typeof base.options.showMaxPage ==='function'){
                base.options.showMaxPage(max_page);
            }
		...
		base.callMethod = function (method, key, value) {
			...
			switch (method.toLowerCase()) {
				...
				case 'option':
					...
					if( result === false ) debug.error('jqPagination: cannot get / set option ' + key);
					return result;
				...
				default:
					...
					debug.error('jqPagination: method "' + method + '" does not exist');
					return false;
